...
After training with three different algorithms, I compared their accuracies to see which one performs better than others.
...
From the result, I can conclude that both Random Forest and Linear Discriminant Analysis have good accuracy. However, Decision Tree doesn't seem to perform well for this task.
